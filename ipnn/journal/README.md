...
| [2026-08-23-0155 — 002-M1g: earned durability works, grace backfires](./entries/2026-08-23-0155-economy.md) | The two economy fixes on the innate scaffold [J] | **Durability alone: first sustained rising learning on the hard geometry** (0.48/0.64/0.59, climbing) keeping only the earning ~10% of routes. Grace floods the sheet with rent-free junk and makes things worse. Reproduction check of 2103 passed at HEAD. Demo gains the Durable arm; L-043, L-044 |
| [2026-08-22-2103 — The innate scaffold works on contact, and the economy demolishes it](./entries/2026-08-22-2103-innate-scaffold.md) | Javid's proposal [J]: random interconnections at birth, then strengthen/rewire; kill failures, mutate signal | **First learning ever on this geometry** — 0.50 blocks from birth with long-span seeds; local-span control: nothing. Then w2 20–29→0: flat rent (+irreplaceable long edges) eats the inheritance in ~24-trial auditions. Wires and weights must have different lifetimes; evolution loop scheduled after the economy fix; L-041, L-042, H-023, H-024 |
| [2026-08-22-2057 — What biology actually does](./entries/2026-08-22-2057-biology-of-growth.md) | Theory [J]: ground the growth model in real neural development | Development = **genome routes coarse topology → structured waves carry correlations → Hebbian growth refines → overproduce/prune → staged plasticity**. 002 is stage 3 alone, fed white noise — a corner no animal occupies (H-020). Convergence program re-founded as experiment 006, the developing substrate; H-020…H-022 |
| [2026-08-22-2030 — Fifty knobs, zero pixels closer](./entries/2026-08-22-2030-knob-ladder.md) | The 002 knob ladder [J]: 50 deliberate variations × 2 seeds | **within-2-hops = 0 on every arm**; best worst-seed tail 0.30 vs gate 0.80. Knobs fix the starved readout (19→70 edges) and it doesn't matter — the wire is thicker, the signal still absent. Knob phase closed; mechanisms next; L-040 |
| [2026-08-22-2022 — 001 is not the IPNN](./entries/2026-08-22-2022-001-is-not-the-ipnn.md) | Doctrine [J] | **Every experiment runs on the grown substrate from now on**; 001 is a harness/control only; the standing priority is a growth model that converges. Supersedes 1917's decision; 004/005 parked |
| [2026-08-22-1917 — Adapt, don't relearn](./entries/2026-08-22-1917-adapt-not-relearn.md) | Theory: Javid's reframing after the stopped clock | **A rule flip is a communication-protocol change, not a knowledge change** [J]; rules can be *shown* (a rules cortex) or *inferred*, and those are different challenges; the dual axis is varying inputs with fixed protocol; together a 2×2 whose far cell is the target. H-018/H-019 registered; **experiment 005 pre-registered** as the next step |
| [2026-08-22-1830 — The stopped clock](./entries/2026-08-22-1830-stopped-clock.md) | Javid's 23-flip run of the demo, decoded | A 100% frozen organism "recovered" 11/23 times **at the measurement floor** — the alternating world kept returning to its frozen mapping. And under never-returning rules **both arms collapse** (1/11 each): flexible synapses ≠ flexible behaviour. Scoreboard now splits re-alignment from re-learning; track H gains requirement #3; L-038, L-039 |
