...
|---|---|---|---|
| [001](./experiments/001-mnist-living-demo/design.md) | MNIST living demo | **Control arm / harness — NOT the IPNN** (fixed, hand-designed architecture; see vision.md \"What this is not\") · M1 gate passed — reward-only learning works at toy scale · **M1b ablation shows the pool's plasticity earns nothing** (L-010) · **[live demo](https://claude.ai/code/artifact/1318cf33-a77e-4c86-b699-784f0c4f3c24)** | Can it learn digits in real time through reward alone — and keep performing when rewards stop? |
| [003](./experiments/003-transfer-retention/design.md) | Transfer & retention | **Run.** All three gates passed, then the design was found flawed — same outputs with different stimuli is a union, not interference. Corrected test (reversal) shows forgetting **below chance** and relearning 7.7× slower (L-029, L-030) · **[live demo](https://claude.ai/code/artifact/4751e69e-739c-459f-814c-2669a3229349)** | Does 001 learn a second task without losing the first — the project's own definition of intelligence, tested for the first time |
| [005](./experiments/005-rules-as-a-sense/design.md) | The rule as a sense | Design only — pre-registered. Javid's "rules cortex": show the protocol through a sense and a flip should cost ~nothing (H-018) | If the rule in force is visible, can it learn both protocols conditioned on the cue — already learned, adapting instantly? |
